...
/**
 * Register the atlassian-create-shell-stories tool with the MCP server
 * @param mcp - MCP server instance
 */
export function registerAtlassianCreateShellStoriesTool(mcp: McpServer): void {
  mcp.registerTool(
    'atlassian-create-shell-stories',
    {
    ...
    async ({ 
      ...
      console.log('atlassian-create-shell-stories called', { 
        jiraEpicId, 
        cloudId, 
        siteName
      });
