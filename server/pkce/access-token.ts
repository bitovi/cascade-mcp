...
async function handleAuthorizationCodeGrant(
  ...
  if (connectionHubTokens) {
    ...
    // We already have both access and refresh JWTs from the connection hub flow
    ...
    res.json({
      ...
      refresh_token: connectionHubTokens.refreshToken,
  ...
  console.log('  🔄 Atlassian authorization code - exchanging with Atlassian');
