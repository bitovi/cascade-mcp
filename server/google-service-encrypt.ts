    ...
    <div class="container">
      <div class="card">
        ...
        <div class="alert alert-info">
          <p>📝 Paste your Google service account JSON below (typically named <code>google.json</code>). We'll encrypt it and give you a string you can use with Google Doc conversion tools.</p>
        </div>
...
export async function handleEncryptionRequest(req: Request, res: Response): Promise<void> {
  try {
    ...
    if (!parsed.client_email || !parsed.private_key || !parsed.project_id) {
      throw new Error(
        'Invalid service account JSON. Missing required fields (client_email, private_key, or project_id)',
      );
    }
  ...
  <main>
    <div class="container">
      <div class="card">
        ...
        <p style="color: #6b7280; font-size: 0.875rem; margin-bottom: 0.75rem;">Copy this encrypted string and store it safely:</p>
      ...
      <div class="card">
        <div class="usage-section">
          ...
          <div class="usage-subtitle">Store in environment variable</div>
          <pre><code># .env file
GOOGLE_SERVICE_ACCOUNT_ENCRYPTED=RSA-ENCRYPTED:...

# Your Google Doc tools will automatically use this encrypted credential</code></pre>
          
          <div class="usage-subtitle">Pass to Google Doc conversion tools</div>
          <p style="color: #6b7280; font-size: 0.875rem; margin-top: 0.5rem;">Use this encrypted string wherever Google service account credentials are needed for converting Google Docs to Markdown.</p>
        </div>
      </div>
