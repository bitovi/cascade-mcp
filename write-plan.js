...
const content = `# Implementation Plan: Google Drive Document to Markdown Converter
...
- Native Google Docs HTML export capability (no additional libraries needed)
- \`marked@latest\` (already in codebase via transitive deps - HTML parsing if needed)  
...
**Violations Requiring Justification**: None - follows all established patterns
...
├── plan.md              # This file
├── research.md          # Phase 0: Google Drive export formats, HTML-to-Markdown libraries
...
const outputPath = path.join(__dirname, 'specs', '036-gdocs-markdown', 'plan.md');
fs.writeFileSync(outputPath, content, 'utf8');
console.log('Plan file written successfully');
